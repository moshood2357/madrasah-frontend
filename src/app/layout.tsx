...
const SITE_DESC =
  "Dar Al-Arqam Global Institute is a comprehensive Islamic learning institution offering Quran recitation, Hifz, Tajweed, Fiqh, Aqeedah, Arabic, Hadith, Seerah, and Islamic Studies for children, teenagers, and adults worldwide. Live online classes, qualified instructors, rooted in the Quran and Sunnah.";

const TWITTER_HANDLE = "@daralarqam";

const OG_IMAGE = {
  url: `${SITE_URL}/logo4.png`,
  width: 1200,
  height: 630,
  alt: "Dar Al-Arqam Global Institute — Authentic Islamic Education Online",
};
