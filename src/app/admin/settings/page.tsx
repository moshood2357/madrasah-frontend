...
import ProfileSettings  from "@/components/admin-panel/settings/ProfileSettings";
import PasswordSettings from "@/components/admin-panel/settings/PasswordSettings";
import MadrasahSettings from "@/components/admin-panel/settings/MadrasahSettings";
import DangerZone       from "@/components/admin-panel/settings/DangerZone";
